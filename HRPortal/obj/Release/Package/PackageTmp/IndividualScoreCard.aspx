            ...
            <table class="table table-bordered table-striped">
                ...
                <%
                    ...
                    <tr>
                        ...
                        <td><label  class="btn btn-danger" onclick="removeLine('<% =line.EntryNo %>','<%=line.Initiative_No %>');"><i class="fa fa-trash"></i> Delete</label></td>
                    </tr>
                    <% 
                      }
                %>
  ...
  <div class="modal-dialog">
    ...
    <script>
        function removeLine(entryNo, InitiativeNo) {
            ...
            document.getElementById("ContentPlaceHolder1_lineNo").innerText = entryNo;

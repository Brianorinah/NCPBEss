...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="panel-body">
            ...
            <table class="table table-bordered table-striped">
                ...
                <%
                    ...
                    var headers = nav.OpenDailyWorkTicket.Where(x => x.Daily_Work_Ticket == requisitionNo && (x.Status=="Open" || x.Status=="Pending Approval") && x.Driver_Allocated ==Convert.ToString(Session["employeeNo"])).ToList();
    ...
    function sendApprovalRequest(documentNumber) {
        ...
        document.getElementById("ContentPlaceHolder1_WorkTicketToApprove").value = documentNumber;
        ...
        function cancelApprovalRequest(documentNumber) {
            ...
            document.getElementById("ContentPlaceHolder1_cancelWorkTicketNo").value = documentNumber;

    ...
    <div class="row">
        <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Open Vehicle Maintenance Requisitions</li>
            </ol>
        </div>
    </div>
            ...
            <table  id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <%
                        ...
                        var filelines = nav.VehicleMaintenanceRequisition.Where(x => x.Requested_By == employeeNo && (x.Status=="Open" || x.Status=="Pending Approval")).ToList();
                    ...
                    <tr>
                        ...
                        <td><a href="VehicleServiceRequisition.aspx?step=1&&requisitionNo=<%=file.Requisition_No %>" class="btn btn-success">View/Edit</a></td>
                    </tr>
                    <%
                        } %>
                </tbody>

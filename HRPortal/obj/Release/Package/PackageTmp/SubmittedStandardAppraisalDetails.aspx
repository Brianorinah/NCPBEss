...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Submitted Standard Appraisal Details</li>
            </ol>
        </div>
    </div>
<div class="panel panel-primary">
    <% string docNo = Request.QueryString["docNo"];
        ...
        <div class="panel panel-heading">
            <h3 class="panel-title">Submitted Standard Appraisal Details</h3>
        </div>  
        <div runat="server" id="feedback"></div>
            <ul class="nav nav-pills" role="tablist">
                 <ul class="nav nav-tabs">
                      ...
                      <li style="background-color:#D3D3D3">
                            <a href="#improvement" data-toggle="tab"><h3 class="panel-title" style="color:black">Evaluation Improvement Plan </h3></a>
                        </li>
                      <li style="background-color:#D3D3D3">
                            <a href="#training" data-toggle="tab"><h3 class="panel-title" style="color:black">Evaluation Training Needs </h3></a>
                        </li>

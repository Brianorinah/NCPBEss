...
namespace HRPortal
{
    public partial class PettyCashSurrenders : System.Web.UI.Page
    {
        ...
        protected void cancelApproval_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //String status = Config.ObjNav.CancelPettyCashSurrenderApproval((String)Session["employeeNo"], tDocumentNo);
        ...
        protected void sendApproval_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //String status = Config.ObjNav.SendPettyCashSurrenderApproval(Convert.ToString(Session["employeeNo"]), imprestNo);
                //String[] info = status.Split('*');

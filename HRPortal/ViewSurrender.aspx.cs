...
namespace HRPortal
{
    public partial class ViewSurrender : System.Web.UI.Page
    {
        ...
        protected void approvalRequestClick(object sender, EventArgs e)
        {
            try
            {
                ...
                Div1.InnerHtml = "<div class='alert alert-" + info[0] + "'>" + info[1] +
            ...
            {
                Div1.InnerHtml = "<div class='alert alert-danger'>" + t.Message +
                                     "<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a></div>";
            }
        }

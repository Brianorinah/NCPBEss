<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="StaffCreditSales2.aspx.cs" Inherits="HRPortal.StaffCreditSalesOpen" %>
...
<asp:Button runat="server" CssClass="btn btn-danger" Text="Send Approval Request" OnClick="send_Approval_Click" />
</div>
</div>

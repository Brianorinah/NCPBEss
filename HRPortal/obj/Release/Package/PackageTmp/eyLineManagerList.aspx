<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="eyLineManagerList.aspx.cs" Inherits="HRPortal.eyLineManagerList" %>
    ...
    <div class="row">
        <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Eny Year List</li>
            </ol>
        </div>
    </div>
                        ...
                        if (!string.IsNullOrEmpty((string)Session["employeeNo"]))
                        {
                            ...
                            if (allInfo != null)
                            {
                                foreach(var item in allInfo)
                                {
                                   ...
                                   if (arr[9] == "Supervisor Level" && arr[5] == "No" && arr[6] == "No" && arr[7] == "No")
                                    {
                                %>
                                    <td><%=arr[0] %> </td>
                                    <td><%=arr[1] %> </td>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportBankSummary.aspx.cs" Inherits="HRPortal.ReportBankSummary" %>
                ...
                <div class="row" style="display: flex; align-items: center;">
                    ...
                    <div runat="server" id="rangeDiv" visible="false">
                        <div class="col-md-5 col-lg-5" style="margin-right: 30px!important;">
                            <div class="form-group">
                                <label>Bank Account Filter 1</label>

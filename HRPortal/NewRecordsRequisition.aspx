...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <asp:TextBox runat="server" ID="expectedreturndate" CssClass="form-control" TextMode="Date" />
            </div>--%>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <strong>File Class:</strong>
                         <asp:DropDownList runat="server" CssClass="form-control" ID="fileclassess" OnSelectedIndexChanged="FileClass_SelectedIndexChanged" AutoPostBack="true"/>
                    </div>
                    <div class="form-group">
                        <strong>File Number:</strong>
                      <asp:DropDownList runat="server" CssClass="form-control" ID="filenumber"  />
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
            ...
            <div class="panel-body">
                <table class="table table-bordered table-striped datatable" id="dataTables-example" >
                    ...
                    <tr>
                        ...
                        <td><label class="btn btn-success" onclick="editfilelines('<%=file.Document_No %>','<%=file.Line_No %>','<%=file.File_Number %>', '<%=file.File_Type %>','<%=file.Purpose_Description %>');"><i class="fa fa-pencil"></i> Edit</label></td>
                        <td><label class="btn btn-danger" onclick="removeRecordFile('<%=file.Document_No %>','<%=file.Line_No %>','<%=file.File_Description %>');"><i class="fa fa-trash-o"></i> Remove</label></td>
    ...
    <script>
        function editfilelines(Document_No, Line_No, File_Number, File_Type, Purpose_Description) {
            document.getElementById("ContentPlaceHolder1_editFileline").value = Line_No;
            document.getElementById("ContentPlaceHolder1_editdocnumber").value = Document_No;
            document.getElementById("ContentPlaceHolder1_editFileClass").value = File_Type;
            document.getElementById("ContentPlaceHolder1_editFileNumber").value = File_Number;
            document.getElementById("ContentPlaceHolder1_editdescription").value = Purpose_Description;            
  ...
  <script>
      ...
      function removeRecordFile(Document_No, Line_No, File_Description) {
          ...
          document.getElementById("ContentPlaceHolder1_fileDocNumber").value = Document_No;
          document.getElementById("ContentPlaceHolder1_lineNumber").value = Line_No;

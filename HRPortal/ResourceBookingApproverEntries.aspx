<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResourceBookingApproverEntries.aspx.cs" Inherits="HRPortal.ResourceBookingApproverEntries" %>
        ...
        <div class="cil-md-12 col-lg-12 col-sm-12 col-xs-12">
         <div class="panel panel-primary">
             <div class="panel-heading">
                 Resource Booking Approval Entries
             </div>
             <div class="panel-body">
                ...
                <%
                    ...
                    var leaves = nav.ApprovalEntries.Where(r => r.Document_No == ResourceNo).ToList();
      ...
      <div class="modal-body">
              <table class="table table-striped table-bordered"  style="width:100%">
                ...
                <%
                    ...
                    var ncomment = nav.ApprovalCommentLine.Where(x=> x.Table_ID == ytableid  && x.Record_ID_to_Approve == "Resource Booking Header:" + " " + ResourceNo);

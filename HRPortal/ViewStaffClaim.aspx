...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Staff Claim Requisition</li>
            </ol>
        </div>
    </div>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    ...
                    <asp:TextBox runat="server" ID="safariNumber" CssClass="form-control span3" ReadOnly="true" />
                </div>
                <div class="col-md-6 col-lg-6">
                    <strong>Function Code:<span style="color: red">*</span></strong>
                    <asp:TextBox runat="server" ID="functionCode" CssClass="form-control span3" ReadOnly="true" />
                </div>
            </div>
        </div>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            Attached  Staff Claim Requisition Supporting Documents             
        </div>
        <div class="panel-body">

         ...
         <div class="panel panel-primary">
             ...
             <div class="panel-body">
                ...
                <%
                    ...
                    var leaves = nav.ApprovalEntry.Where(r => r.Document_No == docNo);
      ...
      <div class="modal-body">
              <table class="table table-striped table-bordered"  style="width:100%">
                ...
                <%
                    ...
                    var ncomment = nav.ApprovalCommentLine.Where(x=> x.Table_ID == ytableid  && x.Record_ID_to_Approve == "HR Leave Application:" + " " +docNo);

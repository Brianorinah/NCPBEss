...
namespace HRPortal
{
    public partial class ViewFleet : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    var request = Config.ObjNav1.fnGetFleetRequisitionIndividual(docNo);
                    ...
                    if (info != null)
                    {
                        foreach (var allinfo in info)
                        {
                            ...
                            dtRequired.Text = arr[2];
                            natureOfErrand.Text = arr[3];
                            dtRequired.Text = arr[4];
                            expTimeBack.Text = arr[5];
                        }
                    }
                }
        ...
        protected void approvalRequestClick(object sender, EventArgs e)
        {
            try
            {
                ...
                "setTimeout(function() { window.location.replace('Dashboard.aspx') }, 2500);", true);
                }

...
namespace HRPortal
{
    public partial class StaffCreditSalesNewEdit : System.Web.UI.Page
    {
        ...
        protected void addItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String status = Config.ObjNav2.editStaffCreditSalesLines(documentNo, productCode, quant);
                String[] info = status.Split('*');
        ...
        {
            String documentNo = Request.QueryString["documentNo"];
            Response.Redirect("StaffCreditSalesNewEdit.aspx?step=3&&documentNo=" + documentNo);
        }

        protected void Unnamed2_Click(object sender, EventArgs e)
        {
            String documentNo = Request.QueryString["documentNo"];
            Response.Redirect("StaffCreditSalesNewEdit.aspx?step=2&&documentNo=" + documentNo);
        }
        protected void previous_Click(object sender, EventArgs e)
        {
            String documentNo = Request.QueryString["documentNo"];
            Response.Redirect("StaffCreditSalesNewEdit.aspx?step=1&&documentNo=" + documentNo);
        }

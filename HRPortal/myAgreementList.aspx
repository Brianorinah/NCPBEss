<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="myAgreementList.aspx.cs" Inherits="HRPortal.myAgreementList" %>
                        ...
                        if (!string.IsNullOrEmpty((string)Session["employeeNo"]))
                        {
                            ...
                            if (allInfo != null)
                            {
                                foreach(var item in allInfo)
                                {
                                   ...
                                   if (arr[8] == "Agreement Level" && arr[5] == "No" && arr[6] == "No" && arr[7] == "No")
                                    {
                                %>
                                    <td><%=arr[0] %> </td>
                                    <td><%=arr[1] %> </td>

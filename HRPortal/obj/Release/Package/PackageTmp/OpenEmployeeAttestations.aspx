...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        function sendApprovalRequest(documentNumber) {
            ...
            document.getElementById("ContentPlaceHolder1_recordToApprove").value = documentNumber;
    ...
    <script>
        function cancelApprovalRequest(documentNumber) {
            ...
            document.getElementById("ContentPlaceHolder1_approverecordoNo1s").value = documentNumber;

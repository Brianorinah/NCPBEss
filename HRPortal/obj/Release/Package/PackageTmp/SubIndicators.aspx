        ...
        <div class="panel-body">
            <div id="generalFeedback" runat="server"></div>
             <div class="col-md-12 col-lg-12">
                <strong>CORE ACTIVITY NAME: </strong> <strong style="color:royalblue"><%=Request.QueryString["CoreName"].ToString().ToUpper() %></strong>
            </div>
            <br />
            <hr />
            <div class="row">

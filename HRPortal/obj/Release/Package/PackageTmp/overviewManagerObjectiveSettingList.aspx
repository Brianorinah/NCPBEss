<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="overviewManagerObjectiveSettingList.aspx.cs" Inherits="HRPortal.overviewManagerObjectiveSettingList" %>
                        ...
                        if (!string.IsNullOrEmpty((string)Session["employeeNo"]))
                        {
                            ...
                            if (allInfo != null)
                            {
                                foreach(var item in allInfo)
                                {
                                   ...
                                   if (arr[4] == "Overview Manager" && arr[5] == "No" && arr[6] == "No" && arr[7] == "No")
                                    {
                                %>
                                    <td><%=arr[0] %> </td>
                                    <td><%=arr[1] %> </td>
